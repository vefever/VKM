...
import { ShieldCheck, QrCode, Mail, Loader2 } from "lucide-react";
...
import { useSecuritySettings, type SecuritySettings } from "@/components/admin/security-data";
  ...
  return (
    ...
    >
      ...
      <SectionCard
        ...
        subtitle="Coaches and mentors can also require 2FA on their own account from their profile settings page, even when the platform-wide toggles above are off."
      >
        <p className="text-xs text-muted-foreground">
          As a super admin, your own personal choice is below — the same "Two-factor authentication" section
          every coach and mentor sees on their Profile → Account tab.
        </p>
      </SectionCard>

      {user && <MyTwoFactorSection userId={user.id} />}
